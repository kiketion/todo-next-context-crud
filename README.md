...
First, copy the repo by git commands, or just download it and open it on terminal using 'ls' and 'cd' commandsto get into the folder. Then run the development server:
